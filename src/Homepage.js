  ...
  return (
    <>
      ...
      <article className="hero_section">
        <section>
          <p className="branding">Infrastructure for the cnnected world.</p>
      ...
      <section className="section">
        <div>
          We provide affordable high-speed internet access to college students.
          We understand the importance of staying connected and having access to
          reliable internet, which is why we strive to offer the best service at
      ...
      <section className="qna">
        ...
        <div>
          <p>
            ...
            productive. Thank you for considering our company for your internet
            service needs. Sign up today and experience the difference.
          </p>
          <p>
            We have a dedicated team of experts who are always ready to assist
            you with any questions or concerns you may have. We are committed to
            providing a seamless and stress-free experience for our customers.
          </p>
        </div>
        <div>
          <img
